...
public class Player implements PhysicsCollisionListener
{
    ...
    public void collision(PhysicsCollisionEvent event)
    {
        ...
        try
        {
            ...
            if (event.getNodeA().getName().equals("PlayerNode") && event.getNodeB().getName().equals("Boss"))
            {
                //event.getNodeB().getParent().detachChildNamed("Enemy"); -- this can be used to do powerups
                if (playerDefense < 5)
                {
                    playerHealth -= 25 - playerDefense;
                } else
                {
                    playerHealth--;
                }
            ...
            if (event.getNodeB().getName().equals("PlayerNode") && event.getNodeA().getName().equals("Boss"))
            {
                if (playerDefense < 5)
                {
                    playerHealth -= 25 - playerDefense;
            ...
            if (event.getNodeA().getName().equals("PlayerNode") && event.getNodeB().getName().equals("Bullet"))
            {
                //event.getNodeB().getParent().detachChildNamed("Enemy"); -- this can be used to do powerups
                if (playerDefense < 5)
                {
            ...
            if (event.getNodeB().getName().equals("PlayerNode") && event.getNodeA().getName().equals("Bullet"))
            {
                if (playerDefense < 5)
                {
                    playerHealth -= 5 - playerDefense;
            ...
            if (event.getNodeB().getName().contains("Wall") && event.getNodeA().getName().equals("Bullet"))
            {
                event.getNodeA().removeFromParent();
                event.getNodeA().removeControl(event.getNodeA().getControl(0));
            }
            if (event.getNodeA().getName().contains("Wall") && event.getNodeB().getName().equals("Bullet"))
            {
                event.getNodeB().removeFromParent();
                event.getNodeB().removeControl(event.getNodeB().getControl(0));
            }
            ...
            if (event.getNodeA().getName().equals("Attack") && event.getNodeB().getName().equals("Boss"))
            {
                //hitEnemy = true;
                int enemyHealth = event.getNodeB().getUserData("health");
                boolean isEnergy = event.getNodeA().getUserData("energy");
            ...
            if (event.getNodeB().getName().equals("Attack") && event.getNodeA().getName().equals("Boss"))
            {
                //hitEnemy = true;
                int enemyHealth = event.getNodeA().getUserData("health");
                boolean isEnergy = event.getNodeB().getUserData("energy");
            ...
            if (event.getNodeB().getName().equals("Attack") && event.getNodeA().getName().contains("Wall"))
            {
                boolean isEnergy = event.getNodeB().getUserData("energy");
                if (isEnergy)
                {
            ...
            if (event.getNodeA().getName().equals("Attack") && event.getNodeB().getName().contains("Wall"))
            {
                boolean isEnergy = event.getNodeA().getUserData("energy");
                if (isEnergy)
                {
